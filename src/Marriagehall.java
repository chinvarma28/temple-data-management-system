...
public class Marriagehall extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        jb1.setText("VenkataLaksmi(1)");

        jb2.setText("Sahana(2)");

        jb3.setText("Narayana(3)");

        jb4.setText("ShivaParvathi(4)");

        jb5.setText("MahaMantapa(5)");
        ...
        jb1.getAccessibleContext().setAccessibleName("VenkataLakshmi(1)");
